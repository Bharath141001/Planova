...
5. You'll also receive a **$300 trial credit** (valid 90 days) — the e2-micro is free even after the trial ends.
...
8. Under **Boot disk**, click **Change**:
   ...
   - Boot disk size: `30 GB` (within the free 30 GB limit)
   - Click **Select**
...
> This IP can change if you stop and restart the VM. To make it permanent (still free), click the IP → **Reserve static address**.
...
Replace `YOUR_GCP_IP` with your actual IP. If you see a JSON response, your backend is live.
